...
#Summary Plots of Dependent Variables
```{r} 
plotA <- 
...
plotB <- ggplot(lobbying_activities, mapping = aes(x = level_of_support)) + geom_bar(position = "dodge") + 
...
#Main Variable Regression: Passage or Failure
```{r} 
...
#Multi Variable Regression: Lobbying 
